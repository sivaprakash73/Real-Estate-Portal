...
function Team({ agents }) {
  ...
  return <>
    <div className="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4"><div><h2 className="h5 fw-bold mb-1">Sales team</h2><p className="small text-secondary mb-0">Monitor ownership, workload and conversion across the sales team.</p></div><a href="mailto:?subject=Invitation%20to%20Vetrivelan%20Realty%20sales%20workspace" className="btn btn-brand btn-sm"><i className="bi bi-person-plus me-1" /> Invite team member</a></div>
